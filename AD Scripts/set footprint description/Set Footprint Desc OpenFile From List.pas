...
// Footprint Library File Name    Footprint component name    Description     File path
...
Begin
     For j := 0 To AllFootPrintName.Count - 1 Do
     Begin
          CurrentLib := Client.OpenDocument('PCBLIB' , AllPathList[j] + AllFootprintFile[j]);
