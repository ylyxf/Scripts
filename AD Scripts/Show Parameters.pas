...
Begin
     ...
     ParamCounts := 0;
     ReportStr := LibComp.LibReference + #9;          // a sting = Library reference name  + 'tab'
     ParamsStr := '';
     ...
     Begin
          ...
          Begin
          ParamsStr := ParamsStr + Parameter.Name + ':' + Parameter.Text + #9;               // previous parameter name + value + current parameter name + value
